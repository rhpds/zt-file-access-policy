...
First, install the fapolicyd package on your Red Hat Enterprise Linux
system.
...
meaning all unauthorized processed will be blocked. We can optionally
...
binaries and other applications not installed into the RPM database.
